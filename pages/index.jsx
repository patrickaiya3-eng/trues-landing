  ...
  return (
    <div style={{ 
        ...
        @keyframes sparkle {
          ...
          50% { 
            box-shadow: 0 0 20px rgba(16, 185, 129, 0.8),
                        ...
                        inset 0 0 20px rgba(110, 231, 183, 0.2);
          }
          100% { 
            box-shadow: 0 0 10px rgba(16, 185, 129, 0.4),
                        0 0 20px rgba(52, 211, 153, 0.3),
      ...
      <nav style={{
        ...
        <div style={{ fontSize: '18px', fontWeight: '600', color: '#10B981' }}>Patrick Trues</div>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 10 }} className="hero-text">
          ...
          <p style={{
            ...
            <br /><br />
            By day, I build <a href="https://www.afroviaconnect.com" target="_blank" rel="noopener noreferrer" style={{ color: '#10B981', textDecoration: 'none', fontWeight: '700', cursor: 'pointer' }}>Afrovia</a>—a marketplace connecting African communities in Europe with verified service providers.
            <br /><br />
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <strong style={{ color: '#10B981' }}>What it does:</strong>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ color: '#10B981', fontWeight: '600', marginBottom: '8px' }}>Provider Network</div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>🌍</div>
              <div style={{ color: '#6EE7B7', fontWeight: '600', marginBottom: '8px' }}>European Reach</div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>✓</div>
              <div style={{ color: '#10B981', fontWeight: '600', marginBottom: '8px' }}>Trust System</div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                width: '60px',
                height: '3px',
                background: 'linear-gradient(90deg, #6EE7B7 0%, transparent 100%)',
                margin: '12px auto 0'
              }} />
            </div>
      ...
      <section className="section-padding" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{
            ...
            <span style={{ color: '#6EE7B7' }}>projects</span>
          </h2>
      ...
      <section className="section-padding" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: '600', color: '#10B981', textTransform: 'uppercase', marginBottom: '16px' }}>
                Connect
              </div>
              <div style={{
                display: 'flex',
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: '600', color: '#6EE7B7', textTransform: 'uppercase', marginBottom: '16px' }}>
                Projects
              </div>
              <div style={{
                display: 'flex',
